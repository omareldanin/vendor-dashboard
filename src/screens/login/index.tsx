...
export const LoginScreen = () => {
    ...
    const onSubmit = (values: z.infer<typeof loginFormSchema>) => {
        login({
            key: values.phoneNumber,
            password: values.password,
        });
    };

    return (
        <div className="w-full h-screen default">
            <div className="grid grid-cols-12 h-full w-full">
                <div className="flex flex-col col-span-12 md:col-span-6 lg:col-span-4 justify-center items-center">
                    ...
                    <p className="mb-8">
                        سجل الدخول للمتابعة الى لوحة التحكم المطعم
                    </p>
                    {isError && (
                        <div className="bg-destructive border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4">
                ...
                <div className="hidden sm:hidden md:flex md:col-span-6 lg:col-span-8 ">
                    <img
